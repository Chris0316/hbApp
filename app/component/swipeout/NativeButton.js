...
import {Platform, StyleSheet, Text, TouchableHighlight, TouchableNativeFeedback, TouchableWithoutFeedback, View} from "react-native";
...
const NativeButton = React.createClass({
  ...
  _renderText: function () {
    ...
    return (
      <Text numberOfLines={1} ellipsizeMode="tail" style={ [styles.textButton, this.props.textStyle] }>
        { this.props.children }
      </Text>
    );
  },
